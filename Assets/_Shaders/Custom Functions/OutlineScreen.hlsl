//Shader based on: https://alexanderameye.github.io/outlineshader

#ifndef OUTLINESCREEN_INCLUDED
#define OUTLINESCREEN_INCLUDED
...
void OutlineScreen_float(float2 UV, float OutlineThickness, float DepthSensitivity, float NormalsSensitivity, float ColorSensitivity, float4 OutlineColor, out float4 Out)
{
